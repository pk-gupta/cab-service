...
public class EmployeeRequestDetailContent implements EmailDetailContent {
	...
	private void setOtherDetails(StringBuilder template, EmailTemplateVO emailTemplateVO) {
	    ...
	    template.append("<tr>");
		template.append("<th width=\"40%\" style=\"padding: 5px 5px 5px 5px; text-align: left;\">Approver</th>");
	    template.append("<td style=\"padding: 5px 5px 5px 5px;\">"+ emailTemplateVO.getManagerName());
	    template.append("</td>");
	    template.append("</tr>");
    ...
    private void setCancelTravelSchedule(StringBuilder template, EmailTemplateVO emailTemplateVO){
    	...
    	/*template.append("<tr>");
		template.append("<th style=\"padding: 5px 5px 5px 5px; text-align: left;\">Cancelled Requests </th>");

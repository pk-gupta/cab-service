...
public class AdminRequestDetailsContent implements EmailDetailContent {
	...
	private void setPrimaryDetails(StringBuilder template, EmailTemplateVO emailTemplateVO) {
		...
		template.append("<tr>");
		template.append("<th width=\"40%\" style=\"padding: 5px 5px 5px 5px; text-align: left;\">Employee Id</th>");
        template.append("<td style=\"padding: 5px 5px 5px 5px;\">"+ emailTemplateVO.getEmployeeId());
        template.append("</td>");
        template.append("</tr>");
		
        template.append("<tr>");
		template.append("<th width=\"40%\" style=\"padding: 5px 5px 5px 5px; text-align: left;\">Employee Name</th>");
        template.append("<td style=\"padding: 5px 5px 5px 5px;\">"+ emailTemplateVO.getEmployeeName());
        template.append("</td>");
        template.append("</tr>");
